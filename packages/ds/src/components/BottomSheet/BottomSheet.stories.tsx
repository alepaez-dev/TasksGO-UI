...
const manyProjects: ProjectPickerProject[] = [
  ...
  },
  {
    ...
    initial: 'A',
    avatarColor: 'var(--ds-color-avatar-tone-project-moss)',
  },
  {
    value: 'beacon',
    label: 'Beacon Analytics',
    initial: 'B',
    avatarColor: 'var(--ds-color-avatar-tone-project-bronze)',
  },
  {
    value: 'coral',
    label: 'Coral Design System',
    initial: 'C',
    avatarColor: 'var(--ds-color-avatar-tone-project-clay)',
  },
  {
    value: 'delta',
    label: 'Delta Infra',
    initial: 'D',
    avatarColor: 'var(--ds-color-avatar-tone-project-steel-dark)',
  },
  {
    value: 'echo',
    label: 'Echo Notifications',
    initial: 'E',
    avatarColor: 'var(--ds-color-avatar-tone-project-violet)',
  },
  {
    value: 'falcon',
    label: 'Falcon Deploys',
    initial: 'F',
    avatarColor: 'var(--ds-color-avatar-tone-project-fern)',
  },
  {
    value: 'granite',
    label: 'Granite Storage',
    initial: 'G',
    avatarColor: 'var(--ds-color-avatar-tone-project-sand)',
  },
  {
    value: 'harbor',
    label: 'Harbor Gateway',
    initial: 'H',
    avatarColor: 'var(--ds-color-avatar-tone-project-indigo)',
  },
  {
    value: 'iris',
    label: 'Iris Identity',
    initial: 'I',
    avatarColor: 'var(--ds-color-avatar-tone-project-teal)',
  },
  {
    value: 'jade',
    label: 'Jade Observability',
    initial: 'J',
    avatarColor: 'var(--ds-color-avatar-tone-project-mauve)',
  },
  {
    value: 'kite',
    label: 'Kite Mobile',
    initial: 'K',
    avatarColor: 'var(--ds-color-avatar-tone-project-denim)',
  },
  {
    value: 'lunar',
    label: 'Lunar Billing',
    initial: 'L',
    avatarColor: 'var(--ds-color-avatar-tone-project-orchid)',
  },
];
