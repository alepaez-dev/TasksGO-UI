...
export const Mobile: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Touch layout: the "add context" affordance is always visible, the task chip opens a bottom sheet, and the formatting toolbar sits above the header and sticks while the notes scroll.',
      },
    },
  },
