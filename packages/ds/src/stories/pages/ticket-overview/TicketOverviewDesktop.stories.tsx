...
function TicketTabPanel({
  ...
  return (
    <div
      role="tabpanel"
      id={getTabPanelId(TAB_ID_PREFIX, value)}
      aria-labelledby={getTabId(TAB_ID_PREFIX, value)}
      className={className}
    >
      {children}
    </div>
          ...
          <div className={styles.tabCard}>
            ...
            <div className={styles.scrollArea}>
              <div className={styles.content}>
                ...
                {activeTab === 'dev' && (
                  <TicketTabPanel value="dev" className={styles.tabPanel}>
                    <Scratchpad
                ...
                {activeTab === 'qa' && (
                  <TicketTabPanel value="qa" className={styles.qaPanel}>
                    <QaPanel
...
export const Qa: Story = {
  render: () => <TicketOverviewRender initialActiveTab="qa" />,
};
