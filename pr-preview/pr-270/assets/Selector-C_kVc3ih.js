import{j as i}from"./jsx-runtime-u17CrQMm.js";import{r as s}from"./iframe-BRfk_XGe.js";import{c as k}from"./cn-2dOUpm6k.js";import{I as R}from"./Icon-CYyrjMm8.js";import{O as K}from"./OptionList-DlK7UKwI.js";function W(){const[n,c]=s.useState(null),[m,o]=s.useState(!1),a=s.useCallback(l=>c(l),[]);return s.useEffect(()=>{if(!n||typeof ResizeObserver>"u"||typeof MutationObserver>"u")return;const l=()=>o(n.scrollWidth-n.clientWidth>1),u=new ResizeObserver(l);u.observe(n);const d=new MutationObserver(l);return d.observe(n,{characterData:!0,childList:!0,subtree:!0}),()=>{u.disconnect(),d.disconnect()}},[n]),[a,m]}const $="_selector_1rvgn_1",H="_trigger_1rvgn_7",F="_triggerPrefix_1rvgn_24",G="_triggerIcon_1rvgn_30",J="_label_1rvgn_35",Q="_chevron_1rvgn_51",U="_inlineTrigger_1rvgn_56",X="_dropdown_1rvgn_71",Y="_dropdownEnd_1rvgn_86",t={selector:$,trigger:H,triggerPrefix:F,triggerIcon:G,label:J,chevron:Q,inlineTrigger:U,dropdown:X,dropdownEnd:Y},x=s.forwardRef(({options:n,value:c,onValueChange:m,open:o=!1,onOpenChange:a,placeholder:l="Select…",triggerPrefix:u,header:d,emptyState:N,action:p,dropdownAlign:_="stretch",variant:T="default",showChevron:C=!0,renderTriggerLabel:g,renderOptionIndicator:h,className:I,"aria-label":b,...j},O)=>{const v=s.useRef(null),r=n.find(e=>e.value===c),S=n.some(e=>e.icon!==void 0),D=n.some(e=>e.prefix!==void 0),f=T==="inline",[E,P]=W(),V=s.useCallback(e=>{if(!e)return;const y=e.querySelector('[aria-selected="true"]');y&&y.scrollIntoView?.({block:"nearest"});const w=e.ownerDocument.activeElement;if(w&&e.contains(w))return;const M=e.querySelector("input, textarea"),A=e.querySelector('[role="option"]');(M??y??A)?.focus()},[]),B=e=>{e.key==="ArrowDown"||e.key==="Enter"||e.key===" "?o||(e.preventDefault(),a?.(!0)):e.key==="Escape"&&o&&(e.preventDefault(),a?.(!1))};function q(e){return D&&e.prefix?`${e.prefix} · ${e.label}`:e.label}function z(){return r?g?g(r):q(r):l}const L=r&&!g&&P?q(r):void 0;return i.jsxs("div",{ref:O,className:k(t.selector,I),...j,children:[i.jsxs("button",{ref:v,type:"button",className:k(t.trigger,f&&t.inlineTrigger),"aria-haspopup":"listbox","aria-expanded":o,"aria-label":b,onClick:()=>a?.(!o),onKeyDown:B,children:[u&&i.jsx("span",{className:t.triggerPrefix,children:u}),S&&r?.icon&&i.jsx(R,{name:r.icon,size:"sm",className:t.triggerIcon,style:r.iconColor?{"--selector-icon-color":r.iconColor}:void 0}),i.jsx("span",{ref:E,className:t.label,title:L,children:z()}),C&&i.jsx(R,{name:f?"expand_more":"unfold_more",size:f?"sm":"md",className:t.chevron})]}),o&&i.jsx("div",{ref:V,role:"presentation",className:k(t.dropdown,_==="end"&&t.dropdownEnd),onKeyDown:e=>{e.key==="Escape"&&!e.defaultPrevented&&(e.preventDefault(),a?.(!1),v.current?.focus())},children:i.jsx(K,{options:n,value:c,"aria-label":b??"Options",header:d,emptyState:N,renderOptionIndicator:h,action:p?{...p,onClick:()=>{p.onClick(),a?.(!1)}}:void 0,onSelect:e=>{m?.(e),a?.(!1),v.current?.focus()}})})]})});x.displayName="Selector";x.__docgenInfo={description:"",methods:[],displayName:"Selector",props:{options:{required:!0,tsType:{name:"union",raw:`| readonly DotOption[]
| readonly IconOption[]
