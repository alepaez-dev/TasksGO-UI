import{j as o}from"./jsx-runtime-u17CrQMm.js";import{r as p}from"./iframe-D4z96_iG.js";import{S as d}from"./Selector-Co0JSguh.js";import{u}from"./useSelector-Cbpp2h-Z.js";import{o as L,a as P,b as E}from"./orderByStyles-Lqvs12bl.js";import{A as g}from"./Avatar-Dm-RUIWj.js";import{S as w}from"./SearchInput-rE_fz0-r.js";import"./preload-helper-CFoSewVc.js";import"./cn-2dOUpm6k.js";import"./Icon-C2ci7jDg.js";import"./OptionList-CZGMKoK-.js";const A=[{value:"eng-core",label:"Engineering Core"},{value:"mudatec",label:"Mudatec"},{value:"tasksgo",label:"TasksGo"}],k={"eng-core":{initial:"E",label:"Engineering Core"},mudatec:{initial:"M",label:"Mudatec"},tasksgo:{initial:"T",label:"TasksGo"}},oe={title:"Components/Selector",component:d,tags:["autodocs"],parameters:{docs:{description:{component:["Selector is fully controlled — pair it with a state hook:","- **`useSelectorState`** — standalone selector with click-outside detection.","- **`useSelectorGroup`** — multiple selectors with mutual exclusion (only one open at a time). Use `useSelectorState` instead when selectors are independent and may open simultaneously."].join(`
