import{j as o}from"./jsx-runtime-u17CrQMm.js";import{r as p}from"./iframe-CNQ74G8X.js";import{S as d}from"./Selector-BSoPK8s2.js";import{u}from"./useSelector-BNlDoo-P.js";import{o as L,a as P,b as E}from"./orderByStyles-Lqvs12bl.js";import{A as g}from"./Avatar-DwQ6GEYS.js";import{S as w}from"./SearchInput-BV6PgwQx.js";import"./preload-helper-BnUZQdSE.js";import"./cn-2dOUpm6k.js";import"./Icon-eU5Ib5rI.js";import"./OptionList-C8TqRW_i.js";const A=[{value:"eng-core",label:"Engineering Core"},{value:"mudatec",label:"Mudatec"},{value:"tasksgo",label:"TasksGo"}],k={"eng-core":{initial:"E",label:"Engineering Core"},mudatec:{initial:"M",label:"Mudatec"},tasksgo:{initial:"T",label:"TasksGo"}},oe={title:"Components/Selector",component:d,tags:["autodocs"],parameters:{docs:{description:{component:["Selector is fully controlled — pair it with a state hook:","- **`useSelectorState`** — standalone selector with click-outside detection.","- **`useSelectorGroup`** — multiple selectors with mutual exclusion (only one open at a time). Use `useSelectorState` instead when selectors are independent and may open simultaneously."].join(`
