import{j as o}from"./jsx-runtime-u17CrQMm.js";import{r as p}from"./iframe-BN46op8z.js";import{S as d}from"./Selector-hTAtmDCg.js";import{u}from"./useSelector-CmTpHEUV.js";import{o as L,a as P,b as E}from"./orderByStyles-Lqvs12bl.js";import{A as g}from"./Avatar-BFrO2Kj_.js";import{S as w}from"./SearchInput-B3Ls8O9_.js";import"./preload-helper-BFzSXVk5.js";import"./cn-2dOUpm6k.js";import"./Icon-50fz-1WT.js";import"./OptionList-D5RZlRhG.js";const A=[{value:"eng-core",label:"Engineering Core"},{value:"mudatec",label:"Mudatec"},{value:"tasksgo",label:"TasksGo"}],k={"eng-core":{initial:"E",label:"Engineering Core"},mudatec:{initial:"M",label:"Mudatec"},tasksgo:{initial:"T",label:"TasksGo"}},oe={title:"Components/Selector",component:d,tags:["autodocs"],parameters:{docs:{description:{component:["Selector is fully controlled — pair it with a state hook:","- **`useSelectorState`** — standalone selector with click-outside detection.","- **`useSelectorGroup`** — multiple selectors with mutual exclusion (only one open at a time). Use `useSelectorState` instead when selectors are independent and may open simultaneously."].join(`
