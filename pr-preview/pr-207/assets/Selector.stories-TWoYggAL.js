import{j as o}from"./jsx-runtime-u17CrQMm.js";import{r as p}from"./iframe-BlVMUn67.js";import{S as d}from"./Selector-B3CioRQW.js";import{u}from"./useSelector-Ch90Uqkk.js";import{o as L,a as P,b as E}from"./orderByStyles-Lqvs12bl.js";import{A as g}from"./Avatar-DSRazEnm.js";import{S as w}from"./SearchInput-DA78Ugmo.js";import"./preload-helper-Cv5kynVY.js";import"./cn-2dOUpm6k.js";import"./Icon-DlLMXf6H.js";import"./OptionList-B2Q9wogE.js";const A=[{value:"eng-core",label:"Engineering Core"},{value:"mudatec",label:"Mudatec"},{value:"tasksgo",label:"TasksGo"}],k={"eng-core":{initial:"E",label:"Engineering Core"},mudatec:{initial:"M",label:"Mudatec"},tasksgo:{initial:"T",label:"TasksGo"}},oe={title:"Components/Selector",component:d,tags:["autodocs"],parameters:{docs:{description:{component:["Selector is fully controlled — pair it with a state hook:","- **`useSelectorState`** — standalone selector with click-outside detection.","- **`useSelectorGroup`** — multiple selectors with mutual exclusion (only one open at a time). Use `useSelectorState` instead when selectors are independent and may open simultaneously."].join(`
