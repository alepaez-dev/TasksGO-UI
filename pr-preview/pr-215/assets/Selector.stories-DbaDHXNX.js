import{j as o}from"./jsx-runtime-u17CrQMm.js";import{r as p}from"./iframe-B9yhVy-p.js";import{S as d}from"./Selector-CiI_arpZ.js";import{u}from"./useSelector-Cq7hpxvR.js";import{o as L,a as P,b as E}from"./orderByStyles-Lqvs12bl.js";import{A as g}from"./Avatar-CXUvrv0O.js";import{S as w}from"./SearchInput-BjeBgbMq.js";import"./preload-helper-Cdrct4L3.js";import"./cn-2dOUpm6k.js";import"./Icon-B33wJhfv.js";import"./OptionList-9M09PIcu.js";const A=[{value:"eng-core",label:"Engineering Core"},{value:"mudatec",label:"Mudatec"},{value:"tasksgo",label:"TasksGo"}],k={"eng-core":{initial:"E",label:"Engineering Core"},mudatec:{initial:"M",label:"Mudatec"},tasksgo:{initial:"T",label:"TasksGo"}},oe={title:"Components/Selector",component:d,tags:["autodocs"],parameters:{docs:{description:{component:["Selector is fully controlled — pair it with a state hook:","- **`useSelectorState`** — standalone selector with click-outside detection.","- **`useSelectorGroup`** — multiple selectors with mutual exclusion (only one open at a time). Use `useSelectorState` instead when selectors are independent and may open simultaneously."].join(`
