import{j as o}from"./jsx-runtime-u17CrQMm.js";import{r as p}from"./iframe-D3VdyC6t.js";import{S as d}from"./Selector-ylNNl_Pr.js";import{u}from"./useSelector-DETedi1p.js";import{o as L,a as P,b as E}from"./orderByStyles-Lqvs12bl.js";import{A as g}from"./Avatar-DTJOwc84.js";import{S as w}from"./SearchInput-CO7tY1Gl.js";import"./preload-helper-HGy384GA.js";import"./cn-2dOUpm6k.js";import"./Icon-DqKrj31W.js";import"./OptionList-BMgDYZx7.js";const A=[{value:"eng-core",label:"Engineering Core"},{value:"mudatec",label:"Mudatec"},{value:"tasksgo",label:"TasksGo"}],k={"eng-core":{initial:"E",label:"Engineering Core"},mudatec:{initial:"M",label:"Mudatec"},tasksgo:{initial:"T",label:"TasksGo"}},oe={title:"Components/Selector",component:d,tags:["autodocs"],parameters:{docs:{description:{component:["Selector is fully controlled — pair it with a state hook:","- **`useSelectorState`** — standalone selector with click-outside detection.","- **`useSelectorGroup`** — multiple selectors with mutual exclusion (only one open at a time). Use `useSelectorState` instead when selectors are independent and may open simultaneously."].join(`
