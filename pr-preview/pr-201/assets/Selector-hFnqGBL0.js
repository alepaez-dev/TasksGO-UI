import{j as a}from"./jsx-runtime-u17CrQMm.js";import{r as d}from"./iframe-BkxkAkzO.js";import{c as m}from"./cn-2dOUpm6k.js";import{I as q}from"./Icon-DjBeAuJY.js";import{O as B}from"./OptionList-CaLMpbKh.js";const A="_selector_1qdtz_1",K="_trigger_1qdtz_5",L="_triggerPrefix_1qdtz_22",M="_triggerIcon_1qdtz_28",$="_label_1qdtz_33",H="_chevron_1qdtz_48",F="_inlineTrigger_1qdtz_53",G="_dropdown_1qdtz_67",J="_dropdownEnd_1qdtz_82",r={selector:A,trigger:K,triggerPrefix:L,triggerIcon:M,label:$,chevron:H,inlineTrigger:F,dropdown:G,dropdownEnd:J},w=d.forwardRef(({options:o,value:p,onValueChange:k,open:i=!1,onOpenChange:t,placeholder:b="Select…",triggerPrefix:g,header:x,emptyState:R,action:l,dropdownAlign:N="stretch",variant:_="default",showChevron:C=!0,renderTriggerLabel:v,renderOptionIndicator:j,className:I,"aria-label":f,...T},h)=>{const s=d.useRef(null),n=o.find(e=>e.value===p),O=o.some(e=>e.icon!==void 0),S=o.some(e=>e.prefix!==void 0),u=_==="inline",D=d.useCallback(e=>{if(!e)return;const c=e.querySelector('[aria-selected="true"]');c&&c.scrollIntoView?.({block:"nearest"});const y=e.ownerDocument.activeElement;if(y&&e.contains(y))return;const P=e.querySelector("input, textarea"),V=e.querySelector('[role="option"]');(P??c??V)?.focus()},[]),E=e=>{e.key==="ArrowDown"||e.key==="Enter"||e.key===" "?i||(e.preventDefault(),t?.(!0)):e.key==="Escape"&&i&&(e.preventDefault(),t?.(!1))};function z(){return n?v?v(n):S&&n.prefix?`${n.prefix} · ${n.label}`:n.label:b}return a.jsxs("div",{ref:h,className:m(r.selector,I),...T,children:[a.jsxs("button",{ref:s,type:"button",className:m(r.trigger,u&&r.inlineTrigger),"aria-haspopup":"listbox","aria-expanded":i,"aria-label":f,onClick:()=>t?.(!i),onKeyDown:E,children:[g&&a.jsx("span",{className:r.triggerPrefix,children:g}),O&&n?.icon&&a.jsx(q,{name:n.icon,size:"sm",className:r.triggerIcon,style:n.iconColor?{"--selector-icon-color":n.iconColor}:void 0}),a.jsx("span",{className:r.label,children:z()}),C&&a.jsx(q,{name:u?"expand_more":"unfold_more",size:u?"sm":"md",className:r.chevron})]}),i&&a.jsx("div",{ref:D,role:"presentation",className:m(r.dropdown,N==="end"&&r.dropdownEnd),onKeyDown:e=>{e.key==="Escape"&&!e.defaultPrevented&&(e.preventDefault(),t?.(!1),s.current?.focus())},children:a.jsx(B,{options:o,value:p,"aria-label":f??"Options",header:x,emptyState:R,renderOptionIndicator:j,action:l?{...l,onClick:()=>{l.onClick(),t?.(!1)}}:void 0,onSelect:e=>{k?.(e),t?.(!1),s.current?.focus()}})})]})});w.displayName="Selector";w.__docgenInfo={description:"",methods:[],displayName:"Selector",props:{options:{required:!0,tsType:{name:"union",raw:`| readonly DotOption[]
| readonly IconOption[]
