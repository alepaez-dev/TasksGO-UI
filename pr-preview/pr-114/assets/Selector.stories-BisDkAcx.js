import{j as o}from"./jsx-runtime-u17CrQMm.js";import{r as p}from"./iframe-S-PAnwZK.js";import{S as d,u}from"./useSelector-_zidvBUV.js";import{o as L,a as P,b as E}from"./orderByStyles-Lqvs12bl.js";import{A as g}from"./Avatar-ivqQVVxz.js";import{S as w}from"./SearchInput-DgR4dP7H.js";import"./preload-helper-BedrK6Ur.js";import"./cn-2dOUpm6k.js";import"./Icon-ChH-veeH.js";const A=[{value:"eng-core",label:"Engineering Core"},{value:"mudatec",label:"Mudatec"},{value:"tasksgo",label:"TasksGo"}],k={"eng-core":{initial:"E",label:"Engineering Core"},mudatec:{initial:"M",label:"Mudatec"},tasksgo:{initial:"T",label:"TasksGo"}},Z={title:"Components/Selector",component:d,tags:["autodocs"],parameters:{docs:{description:{component:["Selector is fully controlled — pair it with a state hook:","- **`useSelectorState`** — standalone selector with click-outside detection.","- **`useSelectorGroup`** — multiple selectors with mutual exclusion (only one open at a time). Use `useSelectorState` instead when selectors are independent and may open simultaneously."].join(`
...
}`,...V.parameters?.docs?.source}}};const ee=["Default","Open","WithAction","NoSelection","IconOptions","Searchable","ManyOptions","AvatarOptions","OrderBy"];export{O as AvatarOptions,v as Default,S as IconOptions,y as ManyOptions,x as NoSelection,f as Open,V as OrderBy,j as Searchable,h as WithAction,ee as __namedExportsOrder,Z as default};
