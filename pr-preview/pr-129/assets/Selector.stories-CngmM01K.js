import{j as o}from"./jsx-runtime-u17CrQMm.js";import{r as p}from"./iframe-Bmb3sypx.js";import{S as d}from"./Selector-WWj48wOh.js";import{u}from"./useSelector-BJtvBgUp.js";import{o as L,a as P,b as E}from"./orderByStyles-Lqvs12bl.js";import{A as g}from"./Avatar-ZBeVrg6C.js";import{S as w}from"./SearchInput-DCU4rKq1.js";import"./preload-helper-DToVxV-W.js";import"./cn-2dOUpm6k.js";import"./Icon-D8TX81Tn.js";import"./OptionList-BZjhSeq4.js";const A=[{value:"eng-core",label:"Engineering Core"},{value:"mudatec",label:"Mudatec"},{value:"tasksgo",label:"TasksGo"}],k={"eng-core":{initial:"E",label:"Engineering Core"},mudatec:{initial:"M",label:"Mudatec"},tasksgo:{initial:"T",label:"TasksGo"}},oe={title:"Components/Selector",component:d,tags:["autodocs"],parameters:{docs:{description:{component:["Selector is fully controlled — pair it with a state hook:","- **`useSelectorState`** — standalone selector with click-outside detection.","- **`useSelectorGroup`** — multiple selectors with mutual exclusion (only one open at a time). Use `useSelectorState` instead when selectors are independent and may open simultaneously."].join(`
