import{j as o}from"./jsx-runtime-u17CrQMm.js";import{r as p}from"./iframe-B4Tu260O.js";import{S as d}from"./Selector-C6UmyiHM.js";import{u}from"./useSelector-B_bZfNkP.js";import{o as L,a as P,b as E}from"./orderByStyles-Lqvs12bl.js";import{A as g}from"./Avatar-BmpHsq2e.js";import{S as w}from"./SearchInput-BeqozOio.js";import"./preload-helper-DEokxZ-p.js";import"./cn-2dOUpm6k.js";import"./Icon-CO3Mzbq4.js";import"./OptionList-DnfuYB5i.js";const A=[{value:"eng-core",label:"Engineering Core"},{value:"mudatec",label:"Mudatec"},{value:"tasksgo",label:"TasksGo"}],k={"eng-core":{initial:"E",label:"Engineering Core"},mudatec:{initial:"M",label:"Mudatec"},tasksgo:{initial:"T",label:"TasksGo"}},oe={title:"Components/Selector",component:d,tags:["autodocs"],parameters:{docs:{description:{component:["Selector is fully controlled — pair it with a state hook:","- **`useSelectorState`** — standalone selector with click-outside detection.","- **`useSelectorGroup`** — multiple selectors with mutual exclusion (only one open at a time). Use `useSelectorState` instead when selectors are independent and may open simultaneously."].join(`
