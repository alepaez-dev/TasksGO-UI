import{j as o}from"./jsx-runtime-u17CrQMm.js";import{r as p}from"./iframe-CF8yrf5b.js";import{S as d}from"./Selector-jZgHNPfu.js";import{u}from"./useSelector-hI3mwG-k.js";import{o as L,a as P,b as E}from"./orderByStyles-Lqvs12bl.js";import{A as g}from"./Avatar-FykAkc1_.js";import{S as w}from"./SearchInput-CEJCOz4L.js";import"./preload-helper-Dxt2lseD.js";import"./cn-2dOUpm6k.js";import"./Icon-DK83se4F.js";import"./OptionList-y1ZjCG32.js";const A=[{value:"eng-core",label:"Engineering Core"},{value:"mudatec",label:"Mudatec"},{value:"tasksgo",label:"TasksGo"}],k={"eng-core":{initial:"E",label:"Engineering Core"},mudatec:{initial:"M",label:"Mudatec"},tasksgo:{initial:"T",label:"TasksGo"}},oe={title:"Components/Selector",component:d,tags:["autodocs"],parameters:{docs:{description:{component:["Selector is fully controlled — pair it with a state hook:","- **`useSelectorState`** — standalone selector with click-outside detection.","- **`useSelectorGroup`** — multiple selectors with mutual exclusion (only one open at a time). Use `useSelectorState` instead when selectors are independent and may open simultaneously."].join(`
