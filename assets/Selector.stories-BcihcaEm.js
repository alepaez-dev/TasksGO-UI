import{j as o}from"./jsx-runtime-u17CrQMm.js";import{r as p}from"./iframe-5Ojt276-.js";import{S as d}from"./Selector-BDBdBIQB.js";import{u}from"./useSelector-BsFLxKdd.js";import{o as L,a as P,b as E}from"./orderByStyles-Lqvs12bl.js";import{A as g}from"./Avatar-J-bi7C2o.js";import{S as w}from"./SearchInput-rlR8-oYZ.js";import"./preload-helper-CyvMmb0J.js";import"./cn-2dOUpm6k.js";import"./Icon-CdNmce14.js";import"./OptionList-DW45-MBw.js";const A=[{value:"eng-core",label:"Engineering Core"},{value:"mudatec",label:"Mudatec"},{value:"tasksgo",label:"TasksGo"}],k={"eng-core":{initial:"E",label:"Engineering Core"},mudatec:{initial:"M",label:"Mudatec"},tasksgo:{initial:"T",label:"TasksGo"}},oe={title:"Components/Selector",component:d,tags:["autodocs"],parameters:{docs:{description:{component:["Selector is fully controlled — pair it with a state hook:","- **`useSelectorState`** — standalone selector with click-outside detection.","- **`useSelectorGroup`** — multiple selectors with mutual exclusion (only one open at a time). Use `useSelectorState` instead when selectors are independent and may open simultaneously."].join(`
